        ...
        var csvFiles = ['phub.csv.csv'];
        var currentTry = 0;
        
        function tryLoadCSV() {
            if (currentTry >= csvFiles.length) {
                document.getElementById('status').innerHTML = 'Error: CSV file not found. Make sure the file is uploaded.';
                ...
                .then(csvText => {
                    ...
                    Papa.parse(csvText, {
                        ...
                        complete: function(results) {
                            ...
                            if (points.length === 0) {
                                document.getElementById('status').innerHTML = 'No valid coordinates found in CSV!';
                                return;
                            }
